<?php
    ...
    if(isset($_GET['id'])) {
        $categoryId = $_GET['id'];
        $category = $categoryController->selectCategoryById($categoryId);
    } else {
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        <div>
                            ...
                            <form action="../../Controller/UpdateCategory.php" method="POST" class="form-box">
                                <input type="hidden" name="category_id" value="<?php echo $category['category_id']; ?>">

                                <div class="mb-3">
                                    <label class="form-label" for="category_name">Category Name:</label>
                                    <input type="text" name="category_name" class="form-control" required value="<?php echo $category['category_name']; ?>">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="description">Description:</label>
                                    <input type="text" name="description" class="form-control" required value="<?php echo $category['description']; ?>">
                                </div>
