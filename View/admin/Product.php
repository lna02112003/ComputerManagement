        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid contain-table">
                        <div class="btn-add">
                                ...
                                <?php if (!empty($products)) { ?>
                                    <?php foreach ($products as $index => $product) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo number_format($product['price_in'], 0, '', ','); ?>,000đ</td>
                                            <td><?php echo number_format($product['price_out'], 0, '', ','); ?>,000đ</td>
                                            <td><?php echo $product['ram']; ?></td>
                                            <td><?php echo $product['storage']; ?></td>
                                            <td><?php echo $product['quantity']; ?></td>
                                            <td><?php echo $product['display_size']; ?></td>
                                            <td><img src="../<?php echo $product['image_url']?>" alt="Product <?php echo $product['category_name']; ?>" width="100px"></td>
                                            ...
                                            <td>
                                                ...
                                                <a href="../../Controller/DeleteProduct.php?id=<?php echo $product['product_id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this product?')">Delete</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                <?php } else { ?>
