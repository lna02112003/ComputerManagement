<?php
    ...
    if(isset($_GET['id'])) {
        $order_id = $_GET['id'];
        $order = $orderController->selectOrderById($order_id);
    } else {
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        <div>
                            ...
                            <form action="../../Controller/UpdateOrder.php" method="POST" class="form-box">
                                <input type="hidden" name="order_id" value="<?php echo $order_id ?>">

                                <div class="mb-3">
                                    <label class="form-label" for="total_order">Total Order:</label>
                                    <input type="text" name="total_order" class="form-control" required value="<?php echo number_format($order->total_order, 0, '', ','); ?>,000đ">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status" value="successful" <?php echo ($order->status == 'Thanh toán thành công') ? 'checked' : ''; ?>>
