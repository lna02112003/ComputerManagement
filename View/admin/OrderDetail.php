<?php
    ...
    if (isset($_GET['id'])){
        ...
        $orderDetails = $orderController->getAllOrderByOrderId($id);
    }
    $orderController = new OrderController($conn);
                                ...
                                <?php if (!empty($orderDetails)) { ?>
                                    <?php foreach ($orderDetails as $index => $order) { ?>
                                        <tr>
                                            ...
                                            <td><img src="../<?php echo $order['image_url']?>" alt="Product <?php echo $order['product_name']; ?>" width="100px"></td>
                                            <td><?php echo $order['quantity']; ?></td>
                                            <td><?php echo number_format($order['unit_price'], 0, '', ','); ?>,000đ</td>
                                            <td><?php echo $order['description']; ?></td>
                                        </tr>
                                    <?php } ?>
                                <?php } else { ?>
                                    <tr>
                                        <td colspan="7">No order detail available.</td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
