<?php
    ...
    $orders = $orderController->SelectAllOrders ();
?>
                        ...
                        <div id="navigation">
                            <ul class="navigation-menu">
                                ...
                                <li class="has-submenu">
                                    ...
                                    <!-- <ul class="submenu">
                                        <li><a href="AccountCustomer.php">Account Customer</a></li>
                                    </ul> -->
                                </li>
                                ...
                                <?php if (!empty($orders)) { ?>
                                    <?php foreach ($orders as $index => $order) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo number_format($order['total_order'], 0, '', ','); ?>,000đ</td>
                                            <td><?php echo $order['description']; ?></td>
                                            <td><?php echo $order['status']; ?></td>
                                            <td>
                                                <a href="OrderDetail.php?id=<?php echo $order['order_id']; ?>" class="btn btn-success">View Order</a>
                                                <a href="editOrder.php?id=<?php echo $order['order_id']; ?>" class="btn btn-primary">Edit</a>
                                                <a href="../../Controller/DeleteOrder.php?id=<?php echo $order['order_id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this order?')">Delete</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                <?php } else { ?>
