<?php
    ...
    $customers = $userController->selectAllCustomer();
        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        <div class="btn-add">
                            <a href="addCategory.php" class="btn btn-primary">Add Customer</a>
                        </div>
                        <table class="table">
                                ...
                                <?php if (!empty($customers)) { ?>
                                    <?php foreach ($customers as $index => $customer) { ?>
                                        <tr>
                                            ...
                                            <td><img src="../<?php echo $customer['img']?>" alt="Customer <?php echo $customer['username']; ?>" width="100px"></td>
                                            <td>
                                                <a href="editCustomer.php?id=<?php echo $customer['customer_id']; ?>" class="btn btn-primary">Edit</a>
                                                <a href="../../Controller/DeleteAccountCustomer.php?id=<?php echo $customer['customer_id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this customer account?')">Delete</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                <?php } else { ?>
                                    <tr>
                                        <td colspan="8">No account customer available.</td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
